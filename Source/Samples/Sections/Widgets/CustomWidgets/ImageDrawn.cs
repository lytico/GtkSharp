...
namespace Samples {
    ...
    public class GtkWorkarounds {
        ...
        static d_gtk_widget_get_scale_factor gtk_widget_get_scale_factor = FuncLoader.LoadFunction<d_gtk_widget_get_scale_factor>(FuncLoader.GetProcAddress(GLibrary.Load(Library.Gtk), "gtk_widget_get_scale_factor"));
